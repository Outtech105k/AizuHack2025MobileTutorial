...
1. [条件分岐と繰り返し](#条件分岐と繰り返し)
1. 処理を塊で考える「関数」
1. (Extra1) `List` `Map`は奥が深い
1. (Extra2) 「万物はただの物」な概念(オブジェクト指向)
1. [References （有用なサイト・チートシート）](#references)
...
- まずは、偶奇判定の方法（アルゴリズム）ですが、判定する数値を 2 で割った余りが 0 か 1 かで判定することができます。
